...
def task_validate_example_files():
  ...
  return {
    'file_dep': climate_data_model.examples + [schema.file_path for schema in climate_data_model.schemas],
...
def task_generate_web_docs():
  ...
  return {
    'file_dep': [schema.file_path for schema in climate_data_model.schemas] + [template.path for template in climate_data_model.doc_templates],
